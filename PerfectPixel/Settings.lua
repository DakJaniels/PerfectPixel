...
function PP:AddBackdropSettings(namespace, updateFn)
    ...
    return
    {
        ...
        {
            type = "iconpicker",
            name = GetString(PP_LAM_LIST_STYLE_BACKDROP),
            ...
            setFunc = function (str)
                sv.skin_backdrop = str
                updateFn(self, namespace)
            end,
            maxColumns = 3,
            visibleRows = 5,
            iconSize = 52,
        ...
        {
            type = "slider",
            name = GetString(PP_LAM_LIST_STYLE_INSETS),
            max = 100,
            min = 0,
            getFunc = function () return sv.skin_backdrop_insets end,
            setFunc = function (value)
                sv.skin_backdrop_insets = value
                updateFn(self, namespace)
            end,
        ...
        {
            type = "checkbox",
            name = GetString(PP_LAM_LIST_STYLE_TILE_LAYING),
            getFunc = function () return sv.skin_backdrop_tile end,
            setFunc = function (value)
                sv.skin_backdrop_tile = value
                updateFn(self, namespace)
            end,
        ...
        },
        {
            ...
            setFunc = function (value)
                sv.skin_backdrop_tile_size = value
                updateFn(self, namespace)
            end,
        ...
        {
            type = "colorpicker",
            name = GetString(PP_LAM_LIST_STYLE_COLOR),
            getFunc = function () return unpack(sv.skin_backdrop_col) end,
            setFunc = function (r, g, b, a)
                sv.skin_backdrop_col = { r, g, b, a }
                updateFn(self, namespace)
            end,
            width = "half",
...
function PP:AddEdgeSettings(namespace, updateFn)
    ...
    return
    {
        ...
        {
            type = "slider",
            name = GetString(PP_LAM_LIST_STYLE_THICKNESS),
            max = 128,
            min = 1,
            getFunc = function () return sv.skin_edge_thickness end,
            setFunc = function (value)
                sv.skin_edge_thickness = value
                updateFn(self, namespace)
            end,
        ...
        },
        {
            ...
            setFunc = function (value)
                sv.skin_edge_file_height = value
                updateFn(self, namespace)
            end,
        ...
        {
            type = "checkbox",
            name = GetString(PP_LAM_LIST_STYLE_STRETCH_TEXTURE_EDGE),
            getFunc = function () return sv.skin_edge_integral_wrapping end,
            setFunc = function (value)
                sv.skin_edge_integral_wrapping = value
                updateFn(self, namespace)
            end,
...
function PP.Settings()
    ...
    if LAM then
        PerfectPixelOptions = LAM:RegisterAddonPanel("PerfectPixelOptions", panelData)
    ...
    table.insert(PP.optionsData,
        {
            type = "submenu",
            name = GetString(PP_LAM_WINDOW_STYLE),
    ...
    table.insert(PP.optionsData,
        {
            type = "submenu",
            name = GetString(PP_LAM_LIST_STYLE),
            controls =
            {
                { type = "header", name = GetString(PP_LAM_LIST_STYLE_BACKDROP), },
                {
                    ...
                    setFunc = function (str)
                        PP.savedVars.ListStyle.list_skin_backdrop = str
                        PP.ResetStyle()
                    end,
                    maxColumns = 3,
                    visibleRows = 5,
                ...
                },
                {
                    ...
                    setFunc = function (value)
                        PP.savedVars.ListStyle.list_skin_backdrop_insets = value
                        PP.ResetStyle()
                    end,
                ...
                },
                {
                    ...
                    setFunc = function (value)
                        PP.savedVars.ListStyle.list_skin_backdrop_tile = value
                        PP.ResetStyle()
                    end,
                ...
                },
                {
                    ...
                    setFunc = function (value)
                        PP.savedVars.ListStyle.list_skin_backdrop_tile_size = value
                        PP.ResetStyle()
                    end,
                ...
                },
                {
                    ...
                    setFunc = function (r, g, b, a)
                        PP.savedVars.ListStyle.list_skin_backdrop_col = { r, g, b, a }
                        PP.ResetStyle()
                    end,
                    width = "half",
                ...
                {
                    type = "colorpicker",
                    name = GetString(PP_LAM_LIST_STYLE_HIGHLIGHT_COLOR),
                    getFunc = function () return unpack(PP.savedVars.ListStyle.list_skin_backdrop_hl_col) end,
                    setFunc = function (r, g, b, a)
                        PP.savedVars.ListStyle.list_skin_backdrop_hl_col = { r, g, b, a }
                        PP.ResetStyle()
                    end,
                    width = "half",
                ...
                { type = "header", name = GetString(PP_LAM_LIST_STYLE_EDGE), },
                {
                    ...
                    setFunc = function (str)
                        PP.savedVars.ListStyle.list_skin_edge = str
                        PP.ResetStyle()
                    end,
                    maxColumns = 3,
                    visibleRows = 5,
                ...
                },
                {
                    ...
                    setFunc = function (value)
                        PP.savedVars.ListStyle.list_skin_edge_thickness = value
                        PP.ResetStyle()
                    end,
                ...
                },
                {
                    ...
                    setFunc = function (value)
                        PP.savedVars.ListStyle.list_skin_edge_file_width = value
                        PP.ResetStyle()
                    end,
                ...
                },
                {
                    ...
                    setFunc = function (value)
                        PP.savedVars.ListStyle.list_skin_edge_file_height = value
                        PP.ResetStyle()
                    end,
                ...
                },
                {
                    ...
                    setFunc = function (r, g, b, a)
                        PP.savedVars.ListStyle.list_skin_edge_col = { r, g, b, a }
                        PP.ResetStyle()
                    end,
                    width = "half",
                ...
                {
                    type = "colorpicker",
                    name = GetString(PP_LAM_LIST_STYLE_SELECTED_COLOR),
                    getFunc = function () return unpack(PP.savedVars.ListStyle.list_skin_edge_sel_col) end,
                    setFunc = function (r, g, b, a)
                        PP.savedVars.ListStyle.list_skin_edge_sel_col = { r, g, b, a }
                        PP.ResetStyle()
                    end,
                    width = "half",
                ...
                },
                {
                    ...
                    setFunc = function (value)
                        PP.savedVars.ListStyle.list_skin_edge_integral_wrapping = value
                        PP.ResetStyle()
                    end,
                ...
                {
                    type = "slider",
                    name = GetString(PP_LAM_LIST_STYLE_FADE_DISTANCE),
                    max = 100,
                    min = 0,
                    getFunc = function () return PP.savedVars.ListStyle.list_fade_distance end,
                    setFunc = function (value)
                        PP.savedVars.ListStyle.list_fade_distance = value
                        PP.ResetStyle()
                    end,
                ...
                {
                    type = "slider",
                    name = GetString(PP_LAM_LIST_STYLE_UNIFORM_CONTROL_HEIGHT),
                    max = 100,
                    min = 1,
                    getFunc = function () return PP.savedVars.ListStyle.list_uniform_control_height end,
                    setFunc = function (value)
                        PP.savedVars.ListStyle.list_uniform_control_height = value
                        PP.ResetStyle()
                    end,
                ...
                {
                    type = "slider",
                    name = GetString(PP_LAM_LIST_STYLE_CONTROL_HEIGHT),
                    max = 100,
                    min = 1,
                    getFunc = function () return PP.savedVars.ListStyle.list_control_height end,
                    setFunc = function (value)
                        PP.savedVars.ListStyle.list_control_height = value
                        PP.ResetStyle()
                    end,
    ...
    table.insert(PP.optionsData,
        {
            ...
            controls =
            {
                ...
                {
                    type = "slider",
                    name = GetString(PP_LAM_FADE_SCENE_DURATION),
                    max = 1000,
                    min = 0,
