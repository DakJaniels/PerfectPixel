...
PP.gameMenuInGameScene = function ()
    ...
    if SV.addons_toggle then
        ...
        PP.Font(ZO_AddOnsPrimaryButtonKeyLabel, --[[Font]] PP.f.u57, 16, 'outline')
        PP.Font(ZO_AddOnsPrimaryButtonNameLabel, --[[Font]] PP.f.u67, 18, 'outline')
        PP.Font(ZO_AddOnsSecondaryButtonKeyLabel, --[[Font]] PP.f.u57, 16, 'outline')
        PP.Font(ZO_AddOnsSecondaryButtonNameLabel, --[[Font]] PP.f.u67, 18, 'outline')
        PP.Font(ZO_AddOnsTitle, --[[Font]] PP.f.u67, 22, 'outline')

        PP.Font(ZO_AddOnsAdvancedUIErrors.label, --[[Font]] PP.f.u67, 18, 'outline')
        if AddonSelector == nil then
            PP.Anchor(ZO_AddOnsCurrentBindingsSaved, --[[#1]] TOPLEFT, ZO_AddOnsList, BOTTOMLEFT, 10, 15)
            PP.Font(ZO_AddOnsCurrentBindingsSaved, --[[Font]] PP.f.u67, 18, 'outline')
        end
