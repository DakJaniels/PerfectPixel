...
PP.tooltips     = function ()
    ...
    SetStyle_Tooltip(NarrowTooltip)
    ...
    SetStyle_Tooltip(GroupFinderGroupListingTooltip)
    SetStyle_Tooltip(ComparativeAbilityTooltip1)
    SetStyle_Tooltip(ChampionSkillTooltip)
    SetStyle_Tooltip(AntiquityTooltip)
    SetStyle_Tooltip(AbilityIconTooltip)
    SetStyle_Tooltip(ZO_Scribing_Keyboard_TLResultTooltip)
    SetStyle_Tooltip(ZO_SmithingTopLevelImprovementPanelResultTooltip)
